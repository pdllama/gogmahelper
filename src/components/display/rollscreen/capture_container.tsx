...
import { bonus_roll, keep_bonus_roll, roll_type, skill_roll } from "@custom_types/rolltype"
...
export default function CaptureContainer({rolls, pid, roll_num, insertRoll, rollType}:CaptureContainerProps) {
    ...
    return (
        <div className="h-fit w-full max-w-[600px] flex flex-col justify-center items-center rounded-md bg-black/100 p-2 gap-2 relative"> {/**sticky top-0 z-5 */}
            ...
            <MhWildsVideo 
                saveRollTools={{
                    profile_id: pid, roll_exists, rollType, roll_num,
