...
export default function Select({selected='', options=[], label_map=undefined, select_classes='', option_classes='', unselected_option_label='Select an option', on_change=() => {}}:SelectProps) {
