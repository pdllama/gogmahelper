...
contextBridge.exposeInMainWorld('ipcRenderer', {
  ...
  run_ocr: (img_buffer:any, rollType:roll_type) => ipcRenderer.invoke("run_ocr", img_buffer, rollType),
  ...
  add_amend_roll: (pid:number, roll:bonus_roll, roll_exists:boolean) => ipcRenderer.invoke('add_amend_roll', pid, roll, roll_exists),
  delete_amend_roll: (pid:number, rollnum:number) => ipcRenderer.invoke('delete_amend_roll', pid, rollnum),
